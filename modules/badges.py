...
CATALOGUE = [
    ...
    Badge(
        ...
        icon="i-book", tier="Getting Started", tile_a="#4e93ff", tile_b="#4e93ff",
    ...
    Badge(
        ...
        icon="i-layers", tier="Getting Started", tile_a="#4e93ff", tile_b="#4e93ff",
    ...
    Badge(
        ...
        icon="i-target", tier="Getting Started", tile_a="#4e93ff", tile_b="#4e93ff",
    ...
    Badge(
        ...
        icon="i-check-circle", tier="Knowledge", tile_a="#4e93ff", tile_b="#7eb6ff",
        evaluate=lambda s: s["passed_quizzes"] >= 1,
    ),
    Badge(
        id="sharp_eye", name="Sharp eye",
        description="Get a perfect score in a simulation.",
        icon="i-eye", tier="Knowledge", tile_a="#4e93ff", tile_b="#7eb6ff",
    ...
    Badge(
        ...
        icon="i-rocket", tier="Milestones", tile_a="#4e93ff", tile_b="#4e93ff",
    ...
    Badge(
        ...
        icon="i-gem", tier="Milestones", tile_a="#4e93ff", tile_b="#7eb6ff",
    ...
    Badge(
        ...
        icon="i-award", tier="Milestones", tile_a="#e6c06a", tile_b="#2dd4ff",
    ...
    Badge(
        ...
        icon="i-flame", tier="Streaks", tile_a="#2dd4ff", tile_b="#e6b455",
    ...
    Badge(
        ...
        icon="i-calendar", tier="Streaks", tile_a="#2dd4ff", tile_b="#e6b455",
