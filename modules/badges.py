...
CATALOGUE = [
    ...
    Badge(
        ...
        icon="i-book", tier="Getting Started", tile_a="#ff5a36", tile_b="#ff5a36",
    ...
    Badge(
        ...
        icon="i-layers", tier="Getting Started", tile_a="#ff5a36", tile_b="#ff5a36",
    ...
    Badge(
        ...
        icon="i-target", tier="Getting Started", tile_a="#ff5a36", tile_b="#ff5a36",
    ...
    Badge(
        ...
        icon="i-check-circle", tier="Knowledge", tile_a="#ff5a36", tile_b="#ff8b6b",
        evaluate=lambda s: s["passed_quizzes"] >= 1,
    ),
    Badge(
        id="sharp_eye", name="Sharp eye",
        description="Get a perfect score in a simulation.",
        icon="i-eye", tier="Knowledge", tile_a="#ff5a36", tile_b="#ff8b6b",
    ...
    Badge(
        ...
        icon="i-rocket", tier="Milestones", tile_a="#ff5a36", tile_b="#ff5a36",
    ...
    Badge(
        ...
        icon="i-gem", tier="Milestones", tile_a="#ff5a36", tile_b="#ff8b6b",
    ...
    Badge(
        ...
        icon="i-award", tier="Milestones", tile_a="#e6c06a", tile_b="#ff8a5c",
    ...
    Badge(
        ...
        icon="i-flame", tier="Streaks", tile_a="#ff8a5c", tile_b="#e6b455",
    ...
    Badge(
        ...
        icon="i-calendar", tier="Streaks", tile_a="#ff8a5c", tile_b="#e6b455",
